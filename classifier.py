...
class classes(Enum):
    ...
    c120 = 2, 120, 4, "Озеро, пруд, водохранилище"
    c130 = 3, 130, 5, "Болото, рисовое поле"
    c140 = 4, 140, 6, "Океан, море"  

    c200 = 5, 200, 7, "Базовый Растительность" #"Объект отсутствует"
    c210 = 6, 210, 8, "Заросли кустарников и прочей низкой растительности (в т.ч. луга и степи)"
    c220 = 7, 220, 9, "Редкий лесной массив (редко стоящие деревья)"
    c230 = 8, 230, 10, "Лесной массив (в т. ч. густые массивы)"

    c300 = 9, 300, 11, "Базовый Площадные объекты" #"Объект отсутствует"
    c310 = 10, 310, 12, "Город или другой населенный пункт"
    c320 = 11, 320, 13, "Промышленное предприятие неопределённого типа"
    c321 = 12, 321, 14, "Порт"
    c322 = 13, 322, 15, "Эл. Станция"
    c323 = 14, 323, 16, "НПЗ"
    c350 = 15, 350, 17, "Пески"   

    c400 = 16, 400, 18, "Базовый Объекты и сооружения"#"Объект отсутствует"
    с401 = 17, 401, 2, "Объект неопределенного типа"
    c410 = 18, 410, 3, "Плотина, дамба"
    с411 = 19, 411, 4, "Мост"
    c420 = 20, 420, 5, "Автомобильная дорога"
    с421 = 21, 421, 6, "Железная дорога"
    c430 = 22, 430, 7, "Линия эл. передач"
    c440 = 23, 440, 8, "Скалы"
    с441 = 24, 441, 9, "Террикон, отвал, насыпь, курган"
    c450 = 25, 450, 10, "Здание неопределенного типа"
    с451 = 26, 451, 11, "Жилое строение"
    с452 = 27, 452, 12, "Промышленное строение или сооружение"
    с453 = 28, 453, 13, "Причал"
    с454 = 29, 454, 14, "Культурные и религиозные здания и сооружения"
    с455 = 30, 455, 15, "Склад"
    с456 = 31, 456, 16, "Склад горючего"
    с460 = 32, 460, 17, "Аэродром"
